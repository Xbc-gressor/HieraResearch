...
# Smoke-task constants: shrunk versus autoresearch-baseline (300 s / 40 units)
# so one evaluation fits a ~2-3 minute budget on a 24 GB GPU. Scores are not
# comparable to the baseline task.

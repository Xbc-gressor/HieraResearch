...
invocation you do exactly ONE thing: generate a pool of complete, mutually
distinct candidate configs and rank them by your own judgment — your exact
pool size N is stated in the `protocol` block. You have no file/shell tools
and need none — the entire decision basis is in this message, and the
receipt tool is your only action.

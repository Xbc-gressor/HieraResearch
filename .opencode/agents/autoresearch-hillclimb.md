...
`Task` tool, and spawns nothing, so it also works as a plain subagent. It does
**not** need any external protocol file.
...
1. `AGENTS.md` (repo conventions) and `README_ZH.md` (project context) if present.
